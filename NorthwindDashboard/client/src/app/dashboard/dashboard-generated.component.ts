...
export class DashboardGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    ...
    this.northwind.getEmployees(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, null, null, this.grid0.allowPaging)
    .subscribe((result: any) => {
  ...
  },
  {
    ...
    this.northwind.getNorthwindOrders(`OrderDate ge 2018-01-01T00:00:00Z`, null, null, null, null, null, null)
    .subscribe((result: any) => {
  ...
  button1Click(event: any) {
    this.northwind.getEmployees(null, null, null, null, null, null, null)
    .subscribe((result: any) => {
  ...
  grid0LoadData(event: any) {
    this.northwind.getEmployees(null, event.top, event.skip, `${event.orderby}`, ``, null, event.top != null && event.skip != null)
    .subscribe((result: any) => {
      this.getEmployeesResult = result.value;
