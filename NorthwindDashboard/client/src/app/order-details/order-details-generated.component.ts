...
export class OrderDetailsGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  load() {
    this.northwind.getNorthwindOrderDetails(null, this.grid0.allowPaging ? this.grid0.pageSize : null, this.grid0.allowPaging ? 0 : null, null, `NorthwindOrder,NorthwindProduct`, null, this.grid0.allowPaging)
  ...
  grid0LoadData(event: any) {
    this.northwind.getNorthwindOrderDetails(`${event.filter}`, event.top, event.skip, `${event.orderby}`, `NorthwindOrder,NorthwindProduct`, null, event.top != null && event.skip != null)
    .subscribe((result: any) => {
      this.getNorthwindOrderDetailsResult = result.value;
